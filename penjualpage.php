...
$qMAK = "CREATE VIEW makanan_view AS SELECT * FROM makanan ORDER BY id_makanan DESC";
$sqlMAK = mysqli_query($connect, $qMAK);
$query = "SELECT * FROM makanan_view";
$sql = mysqli_query($connect, $query);

$qTrans = "CREATE VIEW trans_view as SELECT * FROM transaksi ORDER BY id_transaksi";
$sqlTrans = mysqli_query($connect, $qTrans);
